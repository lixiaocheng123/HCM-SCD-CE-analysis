...
```{r histnoICD, fig.align="center", echo=FALSE, out.width = "80%", fig.cap="Histogram of posterior distributions for state transition probabilities."}
knitr::include_graphics("../../images/post_hist_noICD.png")
```

```{r histICD, fig.align="center", echo=FALSE, out.width = "80%", fig.cap="Histogram of posterior distributions for state transition probabilities."}
knitr::include_graphics("../../images/post_hist_withICD.png")
```
