...
Sudden cardiac death (SCD) risk score algorithm details see [@mahony2014].
...
| Shock | one-off and/or on-going? utility loss | $h_2$ |  |
| HCM without ICD | < 1 ? QALY/year | $h_3$ |  |
...
| Attention to ICD | £1,817? |  | EY10B Tariffs |
| Testing ICD | £467? |  | Tariffs |
| Non-fatal HCM event | £22,880 | $c_2$ | UK Stroke Assoc. |
| e.g shock? | one-off and/or on-going? | | |
| HCM without ICD | ? | $c_3$ |  |
| SCD | ? | $c_4$ |  |
| All-cause death | ? | $c_5$ |  |
|      |      |      |     |
